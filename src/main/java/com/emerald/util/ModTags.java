...
public class ModTags {
    /*public static class Blocks {
        ...
        private static TagKey<Block> createTag(String name) {
            return BlockTags.create(ResourceLocation.fromNamespaceAndPath(EmeraldWeaponsMod.MODID, name));
        }
    }*/
    ...
    public static class Items {
        ...
        private static TagKey<Item> createTag(String name) {
            return ItemTags.create(ResourceLocation.fromNamespaceAndPath(EmeraldWeaponsMod.MODID, name));
        }
    }
}
