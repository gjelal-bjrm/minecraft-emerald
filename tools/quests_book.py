...
QUESTS = [
    ("arcencium", "Le premier Arcencium", "emeraldweapons:raw_arcencium", [
        ...
        "",
        "Attendez l'&bAurore&r : elle montre les filons à travers la roche. Dehors, c'est le Grand Froid : on y gèle, descendez.",
        "",
    ...
    ("arme", "Votre première arme", "emeraldweapons:emerald_sword", [
        ...
        "&bBouclier&r   A F A / A S A / . A .",
        "",
        "&7A lingot d'Arcencium · E émeraude · B branche de Prisme · F fibre de Prisme · N épée en diamant · R arc ordinaire · S bouclier ordinaire · . vide",
        "",
    ...
    ("forge", "La Forge : +1", "emeraldweapons:forge_stone", [
        ...
        "",
        "Un échec ne fait jamais redescendre. Jusqu'à +7, il vous rend le métal et ne coûte que la Pierre ; vers +8, +9 et +10, le métal est perdu aussi.",
        "",
...
HAVEN_QUESTS = [
    ("haven_arrivee", "Vous aviez rendez-vous au quartier général", "minecraft:red_bed", [
        ...
        "",
        "Le quartier général, c'est le &6bar du Hip Hog&r. Votre &6agenda&r (clic droit) donne le prochain rendez-vous ; la barre en haut de l'écran, la distance et la direction. Une voiture vous attend devant l'appartement.",
        "",
        "&7Se coche à la première arrivée.",
    ], []),
    ("haven_qg", "Le quartier général", "minecraft:bell", [
        "Le bar du Hip Hog, où l'équipe se retrouve. Au bout du comptoir, la &cborne&r lance la partie : choisissez ensemble, la vitre bleue pour le Monde ouvert, la rouge pour le Défi.",
        "",
